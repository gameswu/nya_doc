...
如果希望提升好感度，可以首先深入了解小夜的人设。请记住不要将小夜视为一个普通的机器人，她有自己的情感和喜好。尊重理解她才能有更好的交互体验。
...
| `/查看好感` | 查看当前好感度 |
| `/群分析` | 生成群聊分析报告 |
| `/早报` | 基于cngal获取galgame早报 |
| `/查询gal` | 基于touchgal查询galgame信息 |
| `/下载gal` | 基于touchgal下载galgame资源 |
...
该指令用于显示所有指令列表，包括系统指令和插件指令。该列表所含信息为**最新**内容。强烈建议使用该指令来查看可用指令。

### /info

> /info <font color="Blue">[页面]</font>

该指令用于输出该文档的链接。参数`页面`用于指定输出的页面，默认值为`README`。
